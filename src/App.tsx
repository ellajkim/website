    ...
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-3 mt-2">
          <p className="text-sm" style={{ ...monoFont, color: blue.title }}><span className="px-2 py-0.5 rounded-md select-all cursor-text" style={{ background: 'rgba(49, 120, 198, 0.18)', border: '1px solid rgba(49, 120, 198, 0.35)' }}>ellakim [at] princeton [dot] edu</span></p>
